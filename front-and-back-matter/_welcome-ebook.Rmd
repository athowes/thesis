...
For a concise introduction to the work, see my thesis defense [slides](https://athowes.github.io/thesis/slides.pdf).
You can also look at the [corrections](https://athowes.github.io/thesis/correct.pdf) for this thesis.
If you notice typos or other issues, feel free to open an [issue](https://github.com/athowes/thesis/issues) on GitHub, or submit a pull request.
