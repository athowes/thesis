...
The observations in Chapter 4 being from a binomial distribution, to me intuitively, does support further that $\nu$ would be very difficult to estimate, but I could be wrong.
