...
* Note that I've found the pattern is reversed (i.e. normal and what you'd expect) fitting to a subset of countries
* Will paste results of that analysis into here
* Could indicate that the values presented for all countries are just a mistake
* Pending a full refit to test that
