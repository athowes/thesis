...
(ref:mean-sd-alt-latent) Figure caption.
...
(ref:exceedance) Figure caption.

```{r exceedance, fig.cap="(ref:exceedance)"}
knitr::include_graphics(paste0("resources/naomi-aghq/", resource_version, "/depends/exceedance.png"))
```
