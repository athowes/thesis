...
This is a novel approach, enabled by the implementation work of Section \@(universal).
As short-hand, this approach is referred to as LEB.
3. Gaussian marginals and PCA-AGHQ with `TMB`
This is a novel approach, enabled by the methodological work of Section \@(pca-aghq).
...
There were no divergent transitions, and the largest potential scale reduction factor was $\hat R = 1.02$.
