...
(ref:conditional-simulation) Posterior mean of the suitability $\mathbb{E}[\phi(s)]$ (Panel A) and prevalence $\mathbb{E}[\rho(s)]$ (Panel B) random fields.

```{r conditional-simulation, fig.cap="(ref:conditional-simulation)"}
knitr::include_graphics("figures/naomi-aghq/conditional-simulation.png")
```
