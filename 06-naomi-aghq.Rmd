...
The approximate posterior exceedance probabilities from INLA, with both EB and PCA-AGHQ quadrature rule, had systematic inaccuracies as compared with NUTS.
...
NUTS and INLA with the PCA-AGHQ integration strategy could be added to the Naomi web interface as an alternative to INLA with EB.
...
Among the ELGM-type structures of particular interest in spatial epidemiology are aggregated Gaussian process models [@nandi2023disaggregation] and evidence synthesis models [@amoah2020geostatistical].
