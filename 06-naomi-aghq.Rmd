...
Women attending ANC clinics are routined tested for HIV, to help prevent mother-to-child transmission.
...
However, it has complexities which place it outside the class of latent Gaussian models (LGMs, as defined in Section \@ref(lgm)).
Instead, it is an extended latent Gaussian models (ELGMs, as defined in Section \@ref(elgm)).
