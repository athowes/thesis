...
The approach taken in Section \@ref(sec:epil-laplace-eb-tmb) may be extended by integrating with respect to the hyperparameters.
...
&\propto \cdots.
\end{align}
Each of the $N$ objective functions is evaluated at $k \times l$ points, rather than the $1 \times l$ points required in the EB approach.
...
(ref:intercept-comparison) Intercept comparison.
