...
The `gstat::krige` function [@pebesma2004gstat] was used to implement conditional Gaussian field simulation [@sds; Chapter 12] passing in hyperparameter samples one-at-a-time to the `model` argument.

(ref:conditional-simulation) Figure caption.
