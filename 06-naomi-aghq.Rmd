...
However, for seven hyperparameters the posterior contraction was very closet to zero.
...
(ref:nodes-samples-comparison) The 6561 PCA-AGHQ nodes projected onto the 24 hyperparameter marginal distributions obtained with NUTS.
