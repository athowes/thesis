...
The first and third order MMD statistics for GEB were `r`.
Those of GPCA-AGHQ () were just percent lower.
...
The implementation is not intended to replace `R-INLA`, and indeed for the majority of users it is the more suitable software implementation.
Formula-based and universal statistical tools both have value, as they inhabit different roles.
