...
Latent field point estimates obtained from GPCA-AGHQ closer to the gold-standard results from NUTS than the estimates obtained from GEB were (Figure \@ref(mean-sd-alt-latent)).
...
GPCA-AGHQ gave more accurate estimates of the probability that a strata has high HIV incidence than GEB (Figure \@ref(exceedance-1inc)).
Again, both methods had significant error.
Unlike in Section \@(second90), there was little difference in error by sex.
