...
Most applications of and methodological developments relating to the INLA method have used `R-INLA`, with a small number of exceptions [@wood2020simplified; @stringer2022fast].
...
Multinomial then Gaussian.

#### Laplace marginals

Move equations for this here.
...
Choose an example, potentially from Stringer et al, of a model that `R-INLA` can't fit but INLA with `TMB` can.
Demonstrate whether Laplace marginals make a difference to Gaussian marginals there.
