...
"To our knowledge, `TMB` is the only software platform capable of toggling between integration tools [the Laplace approximation and NUTS] so effortlessly." [@monnahan2018no].
Towards adding INLA.
