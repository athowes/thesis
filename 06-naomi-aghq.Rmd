...
```{r}
resource_version <- "20231206-143556-d6fbac86"
...
Informativeness of data about a parameter is summarised by the posterior contraction [@schad2021toward] which compares the prior variance $\sigma_\text{prior}^2(\psi)$ to posterior variance $\sigma_\text{posterior}^2(\psi)$ via
\begin{equation}
