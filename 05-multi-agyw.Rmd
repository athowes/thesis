...
In this chapter, I used behavioural data from household surveys (Section \@ref(agyw-data)) to estimate these quantities using a Bayesian spatio-temporal model (Section \@ref(risk-group-model)).
