...
Kathryn has also created a spreadsheet tool using the estimates available from `https://hivtools.unaids.org/pse/`.
...
MCMC would be intractable for the model, defined over `r n_district` districts, `r n_year` years, `r n_age` age groups, and `r n_group` risk groups.
