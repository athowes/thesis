...
Kathryn has also created a spreadsheet tool using the estimates ([`https://hivtools.unaids.org/pse/`](`https://hivtools.unaids.org/pse/`)) for use in national HIV response planning.
...
Significant investments, such as the DREAMS partnership [@saul2018dreams] and by the GFATM [@global2018measurement], have been made to support prevention programming.
...
I used household survey data from 13 countries identified by the GFATM [@global2018measurement] as priority countries for implementation of AGYW HIV prevention.
...
In decreasing order of HIV acquisition risk, these risk groups were:

1. $k = 1$: Not sexually active
2. $k = 2$: One cohabiting sexual partner
3. $k = 3$: Non-regular or multiple sexual partner(s), and
4. $k = 4$: Reporting transactional sex.
