...
Table: (\#tab:model-comparison) CPO, DIC, and WAIC values for the multinomial logistic regression model specifications with corresponding standard errors.
...
Table: (\#tab:model-comparison) CPO, DIC, and WAIC values for the logistic regression model specifications with corresponding standard errors.
