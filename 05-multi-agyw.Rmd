...
```{r available-surveys, out.width = "90%", echo=FALSE, fig.cap="Surveys."}
...
```{r coverage, out.width = "90%", echo=FALSE, fig.cap="Coverage."}
...
```{r 3p1-continental-map, out.width = "90%", echo=FALSE, fig.cap="Map."}
knitr::include_graphics(paste0("resources/multi-agyw/", resource_version, "/depends/3p1-continental-map.png"))
```

```{r 3p1-within-between-country-variation, out.width = "90%", echo=FALSE, fig.cap="Dots."}
