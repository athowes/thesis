...
The number of new infections that could be "reached" prioritising according to each possible stratification of the population were calculated.
...
```{r}
# Get number of new infections which occur in adults not females 15-29
```
