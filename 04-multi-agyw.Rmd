...
The results are described in @howes2023spatio, and are beginning to be used by countries to guide policy via a spreadsheet tool created by Kathryn.
...
```{r risk-grid, out.width = "90%", echo=FALSE, fig.cap="Risk grid."}
