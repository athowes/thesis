...
Table: (\#tab:unaids-strategy-prioritisation) Prioritisation strata given by @unaids2021global based on to HIV incidence in the general population and behavioural risk.
...
Table: (\#tab:unaids-strategy-targets) Commitments recommended by @unaids2021global to be met for each intervention, given in terms of the proportion of the prioritisation strata reached. The symbol "-" represents no commitment.
