...
(ref:category-flowchart) Flowchart describing allocation of survey respondents to HIV risk groups.

```{r category-flowchart, fig.cap="(ref:category-flowchart)"}
knitr::include_graphics(paste0("resources/multi-agyw/", resource_version, "/depends/category-flowchart.png"))
```
