...
\item
  ...
  Complete surgical removal of the foreskin has been found to result in a reduction of HIV incidence in men by 50-60\% \autocite{auvert2005randomized,gray2007male,bailey2007male}.
...
For example, adult HIV prevalence in South Africa ranges from \texttt{r}7\texttt{\%\ to}r \texttt{32}\%.
