...
Most applications of and methodological developments relating to the INLA method have used \texttt{R-INLA}, with a small number of exceptions \autocite{wood2020simplified,stringer2022fast}.
...
Choose an example, potentially from Stringer et al, of a model that \texttt{R-INLA} can't fit but INLA with \texttt{TMB} can.
