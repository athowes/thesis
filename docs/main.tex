...
The methods developed in this chapter combine Laplace approximations with adaptive quadrature, and are descended from the integrated nested Laplace approximation (INLA) method of \textcite{rue2009approximate}.
...
The success of INLA is in large part due to its implementation in the \texttt{R-INLA} software.
Use or development of INLA outside the \texttt{R-INLA} software has been limited, with some notable exceptions.
