...
Kathryn has also created a spreadsheet tool using the estimates (\href{\%60https://hivtools.unaids.org/pse/\%60}{\texttt{https://hivtools.unaids.org/pse/}}) for use in national HIV response planning.
...
Significant investments, such as the DREAMS partnership \autocite{saul2018dreams} and by the GFATM \autocite{global2018measurement}, have been made to support prevention programming.
...
I used household survey data from 13 countries identified by the GFATM \autocite{global2018measurement} as priority countries for implementation of AGYW HIV prevention.
