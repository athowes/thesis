...
Specifically, the spatio-temporal multinomial logistic regression model is defined over 940 districts, 20 years, 3 age groups, and 3 risk groups.
...
\end{equation}
Using Equations \eqref{eq:multi} and \eqref{eq:mpoisson}, the joint distribution of \(p(\mathbf{y}_{ita}, m_{ita}) = p(\mathbf{y}_{ita} \, | \, m_{ita})p(m_{ita})\) is then
\begin{align}
