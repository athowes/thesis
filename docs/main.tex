...
Inferences for the latent field can be obtained by \autocite{rue2007approximate}
\begin{equation}
...
\end{equation}
then drawing from the corresponding Gaussian distribution \autocite{rue2001fast}
\begin{align}
...
\textcite{rue2009approximate} use GMRFs to approximate the Laplace marginals.

\hypertarget{simplifed-inla}{%
\subsubsection{Simplifed INLA}\label{simplifed-inla}}

\textcite{wood2020simplified} don't use GMRFs to approximate the Laplace marginals and still do fine.
