...
HIV primarily infects CD4+ T cells, a type of white blood cell vital for the function of the immune system.
...
HIV is transmitted by exposure to certain bodily fluids of an infected person.
The most common mode of transmission is through sexual contact.
...
Large demographic groups at increased risk of HIV infection include adolescent girls and young women (AGYW).
...
Important indicators include HIV prevalence, which is the proportion of the population who have HIV; HIV incidence, the rate of new HIV infections; and ART coverage, which is the proportion of PLHIV who are on ART.

There are significant difficulties associated with furnishing these estimates.
The difficulties include data sparsity in space and time, survey bias, conflicting information sources, hard to reach populations, and changing demographics.
These data limitations foreground the importance of statistical modelling, including synthesising multiple sources of information.
...
\subsubsection{Bayesian computation}\label{bayesian-computation}}
...
\subsubsection{Interplay between modelling and computation}\label{interplay-between-modelling-and-computation}}
...
\subsection{Model classes}\label{hierarchical-lgm-elgm}}
...
\subsubsection{Extended latent Gaussian models}\label{extended-latent-gaussian-models}}
