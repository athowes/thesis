...
Over 40 years since the beginning of the epidemic, among non-infants HIV is the largest annual cause of disability adjusted life years (DALYs) in SSA [@ihme2019; Figure \@ref(fig:gbd)].
...
Spatio-temporal data of this sort occur across a diverse range of application settings.
Distinctive recurring commonalities make their collective study worthwhile.
...
* Chapter \@ref(hiv-aids) provides an overview of the HIV/AIDS epidemic, and describes the challenges faced by disease surveillance efforts.
