...
(ref:gbd) HIV/AIDS is the largest cause of DALYs for non-infacts (>1 years) in SSA. One DALY represents the loss of the equivalent of one year of full health, and is calculated by the sum of years of life lost and years lost due to disability. The disability weights used by the @ihme2019 vary depending on severity of the condition.
...
HIV is the largest cause of disability adjusted life years (DALYs) in SSA among those one year and older [@ihme2019; Figure \@ref(fig:gbd)].
...
With this motivation, I develop an approximate Bayesian inference method combining adaptive Gauss-Hermite quadrature with principal components analysis [@howes2023fast].
