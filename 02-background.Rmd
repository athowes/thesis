...
knitr::include_graphics("figures/introduction/overall-picture.png")
```
...
I provide a brief overview in this section, and recommend @mcelreath2020statistical or @gelman2013bayesian for a more complete introduction.
