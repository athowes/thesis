...
For example, Appendix \@ref(bym2-proportion) shows recovery of the BYM2 proportion parameter.
...
Analogously, the BYM2 model was able to infer the proportion parameter for the most part, and as a result performed only somewhat worse than the Besag model.
...
The pointwise CRPS value was high at certain district.
