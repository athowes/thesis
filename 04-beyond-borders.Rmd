...
Mean MSE and CRPS values are provided in Tables \@ref(mse-table) and \@ref(crps-table).
...
Interpretation of CRPS choropleths (Figures \@ref(crps-mean-se-grid), \@ref(crps-mean-se-civ) and \@ref(crps-mean-se-tex)) was challenging primarily due to two factors: varying scores by simulation model, and limited sample size at the area-level.
...
For IID synthetic data, spatial models tend to produce "U"-shaped ECDF difference plots (Figures \@ref(histogram-ecdf-diff-grid), \@ref(histogram-ecdf-diff-civ) and \@ref(histogram-ecdf-diff-tex)).
