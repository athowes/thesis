...
```{r}
resource_version <- "20231216-114240-f49579e4"
```
...
(ref:crps-mean-se-surveys) The mean pointwise leave-one-out CRPS with 95% credible interval (generated using 1.96 times the standard error) in estimating $\rho$ for the four PHIA surveys described in Table \@ref(tab:hiv-surveys) using each inferential model.
