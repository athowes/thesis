...
```{r}
resource_version <- "20231122-173917-8b121ad3"
```
...
(ref:crps-mean-se-grid) The mean CRPS and its standard error for each inferential model and simulation model.
...
(ref:crps-mean-se-civ) The mean CRPS and its standard error for each inferential model and simulation model.
...
(ref:crps-mean-se-tex) The mean CRPS and its standard error for each inferential model and simulation model.
