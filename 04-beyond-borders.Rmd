...
Figures \@ref(fig:crps-mean-se-grid), \@ref(fig:crps-mean-se-civ) and \@ref(fig:crps-mean-se-tex) show mean CRPS values with 95% credible intervals which rarely overlap, and hence provide meaningful findings.
Mean MSE and CRPS values are provided in Tables \@ref(tab:mse-table) and \@ref(tab:crps-table).

The average CRPS varied substantially between the three models (Table \@ref(tab:simulation-models)) used to simulate synthetic data.
