...
w_{ij} = \frac{1}{\pi_{ij}}
\end{equation}
were used to account for the complex survey design whereby an individual has probability $\pi_{ij}$ of being included in the survey.
The weighted prevalence in area $i$ is
\begin{equation}
