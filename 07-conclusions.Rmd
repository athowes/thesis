...
For the first time, practitioners can now fit essentially any model using INLA.
...
Additionally, Chapter \@ref(naomi-aghq) provides detailed description and analysis of the Naomi.
