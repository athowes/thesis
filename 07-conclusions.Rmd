...
Chapter \@ref(beyond-borders) comprehensively compared adjacency- and kernel-based models for spatial structure, using tools for model assessment such as proper scoring rules and posterior predictive checks.
The experiments conducted provide useful data to guide use of spatial random effect models by applied practitioners, as well as to base methodological developments on.
