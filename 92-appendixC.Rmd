...
```{r rhat, fig.cap="The potential scale reduction factor compares between- and within- estimates of univariate parameters. It is generally recommended only to use NUTS results if the potential scale reduction factor is less than 1.05. Here it is for all parameters."}
knitr::include_graphics(paste0("resources/naomi-aghq/", resource_version, "/depends/rhat.png"))
```

```{r ess, fig.cap="Figure caption."}
knitr::include_graphics(paste0("resources/naomi-aghq/", resource_version, "/depends/ess.png"))
```

```{r worst-trace, fig.cap="Figure caption."}
knitr::include_graphics(paste0("resources/naomi-aghq/", resource_version, "/depends/worst-trace.png"))
```

```{r rho-a, fig.cap="Figure caption."}
knitr::include_graphics(paste0("resources/naomi-aghq/", resource_version, "/depends/rho_a.png"))
```

```{r alpha-x, fig.cap="Figure caption."}
