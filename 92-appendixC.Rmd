...
(ref:tmbstan-epil) Traceplots for the `tmbstan` parameters with the worst values of the potential scale reduction factor and effective sample size.
...
(ref:stan-epil) Traceplots for the `rstan` parameters with the worst values of the potential scale reduction factor and effective sample size.
