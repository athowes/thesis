...
The concise $i$ notation used in Section \@ref(naomi) is replaced with more complete $x, s, a$ notation, and the terms in each structured additive predictor are given, along with their distributions.
