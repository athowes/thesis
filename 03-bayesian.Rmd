...
Using this procedure, known as a prior predictive check [@gelman2013bayesian; Chapter 6], models can be built iteratively, with complexity added gradually.
...
Also known as Monte Carlo methods, sampling algorithms [@robert2005monte] look to generate samples from the posterior distribution 
\begin{equation}
...
Markov chain Monte Carlo (MCMC) methods [@roberts2004general] are perhaps the most popular class of sampling algorithms, and proceed by simulating from an ergodic Markov chain with the posterior distribution as its stationary distribution .
...
HMC uses derivatives of the posterior distribution to generate efficient Metropolis-Hastings [@metropolis1953equation; @hastings1970monte] proposal distributions.
