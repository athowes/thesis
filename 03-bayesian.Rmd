...
Alternatively, deterministic approximations can be used, which more directly approximate the posterior distribution or posterior normalising constant.

The Laplace approximation involves approximating the posterior normalising constant using Laplace's method of integration, and is equivalent to approximating the posterior distribution by a Gaussian distribution.
...
Variational inference [VI; @blei2017variational] is another prominent deterministic apppraoch.
