...
```{r}
resource_version <- "20231210-153834-0103a63e"
```
...
(ref:crps-mean-se-civ2017phia) Côte d’Ivoire 2017 PHIA survey (Panel \@ref(fig:hiv-surveys)A).
...
(ref:crps-mean-se-mwi2016phia) Malawi 2016 PHIA survey \@ref(fig:hiv-surveys)B.
...
(ref:crps-mean-se-tza2017phia) Tanzania 2017 PHIA survey \@ref(fig:hiv-surveys)C.
...
(ref:crps-mean-se-zwe2016phia) Zimbabwe 2016 PHIA survey \@ref(fig:hiv-surveys)D.
