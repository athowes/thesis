...
(ref:lengthscale-prior) Six lengthscale prior distributions were considered. These were: $l \sim \text{Gamma}(1, 1)$; $l \sim \text{IG}(a, b)$; $l \sim \mathcal{N}^{+}(0, \sigma)$; $l \sim \text{Log-normal}(0, 1)$; $p(l) = 1$; and $l \sim \mathcal{N}(2.5, 1)$.
...
(ref:lengthscale-posterior) Lengthscale posterior distributions obtained using NUTS to fit a centroid kernel model to integrated kernel data, with six different lengthscale prior distributions as described in Figure \@ref(fig:lengthscale-prior).
...
(ref:lengthscale-recovery) Figure caption.
