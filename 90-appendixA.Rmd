...
| Geometry-informed inverse-gamma | $l \sim \text{IG}(a, b)$ | |
| Geometry-informed normal | $l \sim \mathcal{N}^{+}(0, \sigma)$ | |
| Log-normal | $l \sim \text{Log-normal}(0, 1)$ | |
| Non-informative | $p(l) = 1$ | |
| Oracle normal | $l \sim \mathcal{N}(2.5, 1)$ | |
