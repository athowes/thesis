...
(ref:map-civ2017phia) Cloropleth showing the pointwise CRPS in estimating $\rho_i$ for the Côte d’Ivoire 2017 PHIA survey (Panel \@ref(fig:hiv-surveys)A).
...
(ref:map-mwi2016phia) Cloropleth showing the pointwise CRPS in estimating $\rho_i$ for the Malawi 2016 PHIA survey (Panel \@ref(fig:hiv-surveys)B).
...
(ref:map-tza2017phia) Cloropleth showing the pointwise CRPS in estimating $\rho_i$ for the Tanzania 2017 PHIA survey (Panel \@ref(fig:hiv-surveys)C).
...
(ref:map-zwe2016phia) Cloropleth showing the pointwise CRPS in estimating $\rho_i$ for the Zimbabwe 2016 PHIA survey (Panel \@ref(fig:hiv-surveys)D).
