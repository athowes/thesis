...
<!-- HIV is a big problem that a lot of effort goes into combating -->
The first AIDS cases were reported in Los Angeles in the early 1980s.
Since then, HIV has spread globally, and so far resulted in an estimated `r custom_numbers_to_words(deaths)` deaths.
A major international effort has been made to address the epidemic, including by national governments, civil society organisations, pharmaceutical companies, research institutions, international agencies, and global health initiatives such as the President's Emergency Plan for AIDS Relief (PEPFAR; \$`r custom_numbers_to_words(pepfar)` invested) and the Global Fund to Fight AIDS, Tuberculosis, and Malaria (GFATM; \$`r custom_numbers_to_words(global_fund)` invested).
...
* **ART coverage** The proportion of PLHIV who are on ART, typically given as a percentage.
