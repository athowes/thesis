...
<!-- Practical methods for prevention prioritisation -->
<!-- What is being done and is it working -->
Modes of service delivery include geographic, demographic, key population services, risk screening, individual-level risk characteristics.
...
* **HIV incidence** is the rate $\lambda \in \mathbb{R}$ of new HIV infections, often written as number of new infections per 1000 person years.
HIV incidence can be specified in terms of the change in HIV prevalence, taking into account the mortality rate.
Let $\rho_t$ be the HIV prevalence, and $N_t$ be the population size, at time $t$.
Then the number of new HIV infections is given by
$$
\int \lambda_t \cdot (1 - \rho_t) \cdot N_t \text{d}t.
$$
...
Data are used to estimate the above HIV indicators.
These data are integrated with prior scientific knowledge.
