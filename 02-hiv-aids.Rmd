...
A shortfall in HIV funding [@economist2023triple], disruption to HIV services caused by the COVID-19 pandemic, and increasingly difficult to meet targets.
...
The precision public health paradigm [@khoury2016precision] extends the principles of precision medicine to public health, and aims to provide the right interventions to the right population, in the right place, at the right time.
...
Accurately estimating these denominators is itself a challenging task [@tatem2017worldpop].
Taking a ratio of uncertain quantities amplifies the uncertainty.

The above challenges make direct interpretation of the data misleading.
Along with Careful statistical modelling is required to overcome these limitations.
