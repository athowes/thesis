...
The response has been multifaceted, shaped by local communities, civil society organisations, national governments, research institutions, pharmaceutical companies, international agencies like the Joint United Nations Programme
...
The investment of $`r custom_numbers_to_words(pepfar)` by PEPFAR constitutes the "largest commitment by a single nation to address a single disease in history" [@pepfar2022], indicating the scale of the response.
...
(ref:overall-picture) Globally, yearly new HIV infections peaked in 1995, and have since decreased by 59%. Yearly AIDS-related deaths peaked in 2004, and have since decreased by 68% [@unaids2023aidsinfo]. Much of the global disease burden is concentrated in eastern and southern Africa, as well as western and central Africa. The unit "M" refers to millions. The colour palette used in this figure, and throughout the theiss, is that of @okabe2008color. It is designed to be colourblind friendly, and the default in @wilke2019fundamentals.
...
The most significant evidence-based interventions, in approximately chronological order of their introduction, are described below:
...
The number of AIDS-related deaths, `r custom_numbers_to_words(art_deaths_averted)`, estimated to have been averted by ART is staggering [@unaids2023global].
  ...
  Approaches to lowering risk of HIV transmission this way are referred to as treatment as prevention (TaSP).
...
Three landmark randomised control trials (RCTs) [@auvert2005randomized; @gray2007male; @bailey2007male] found complete surgical removal of the foreskin to result a reduction of HIV acquisition in men by 50-60%.
...
These medical interventions are more costly than some other options, so are primarily useful in high risk settings.
...
Adult HIV prevalence (ages 15-49) is above 10% in some countries in southern Africa, with some districts even exceeding 20% (Figure \@ref(fig:naomi-continent)).
...
For this reason it is important to take caution in directly interpreting changes in HIV prevalence.
Nonetheless, as a primary measure of population disease burden, HIV prevalence is crucial in calculating all of the other indicators given below.
...
The number of new HIV infections that occur during a given time is the integral of the rate of HIV incidence multiplied by the size of the susceptible population.
...
Measuring the above HIV indicators requires data.
...
The surveys conducted in the most countires are Demographic and Health Surveys [DHS ;@measure2012sampling], which include a wide range of health related questions, and more HIV-specific Population-based HIV Impact Assessment [PHIA; @phia] and AIDS Indicator Surveys (AIS).
...
Both DHS and PHIA surveys collecting demographic, behavioural, and clinical information.
...
Furthermore, household surveys are typically powered to have sufficient sample size to be representative at a national-level.
As a result, data for subpopulations are often sparse.
