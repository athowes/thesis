...
Implementation of HIV prevention and treatment has seen both the number of new HIV infections and AIDS-related deaths per year fall significantly since their peak (Figure \@ref(fig:overall-picture)).
...
1. **Greater reliance on routine health system data** It is not recommended to include HIV testing in nationally representative household surveys in low (<2%) HIV prevalence settings [@world2005guidelines]. Patient-level HIV data systems [@world2017consolidated] and case-based surveillance (CBS). Integration of HIV services with other health programs and strengthening of health systems.
