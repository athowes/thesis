...
The investment of $`r custom_numbers_to_words(pepfar)` by PEPFAR, constituting the "largest commitment by a single nation to address a single disease in history" [@pepfar2022], is indicative of the scale of the response.
...
Renewed commitment is required to meet these targets in the context of disruption to HIV services caused by the COVID-19 pandemic and a shortfall in HIV funding [@economist2023triple]. 
...
Estimates of ART coverage play a direct role in provision of treatment services.
...
2. **Integration of HIV services with other health programs** Strengthen health systems.
