...
Differentiated HIV treatment and prevention services can be practically implemented via a number of approaches [@eaton2022aids].
These include geographic and demographic prioritisation, key and vulnerable population services, and risk screening based on individual-level risk characteristics.
